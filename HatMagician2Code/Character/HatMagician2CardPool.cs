...
public class HatMagician2CardPool : CustomCardPoolModel
{
    public override string Title => HatMagician2.CharacterId; //This is not a display name.
    ...
    {
        //This will attempt to load HatMagician2/images/cards/frame.png
