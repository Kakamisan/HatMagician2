...
public partial class BattleBrandColorPet : NCreatureVisuals
{
    ...
    public void SetShow(bool flag) => this.Visible = flag;

    public void SetAlpha(float alpha)
    {
        SetShaderParameter("modulate_alpha", alpha);
        this.Modulate = new Color(1, 1, 1, Math.Min(1, alpha * 1.7f));
    }
    ...
    public void _SubReady()
    {
        ...
        this._shaderMaterial = (ShaderMaterial)this._shaderMaterial.Duplicate();
        this._textureRect!.Material = this._shaderMaterial;
