...
public class BrandRedIntent : DebuffIntent
{
    protected override string IntentPrefix => "HATMAGICIAN2-BRAND_RED";
    ...
    protected override string SpritePath => "intents/brand_red.png";
}