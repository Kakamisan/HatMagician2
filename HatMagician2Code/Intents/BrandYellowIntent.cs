...
public class BrandYellowIntent : DebuffIntent
{
    protected override string IntentPrefix => "HATMAGICIAN2-BRAND_YELLOW";
    ...
    protected override string SpritePath => "intents/brand_yellow.png";
}