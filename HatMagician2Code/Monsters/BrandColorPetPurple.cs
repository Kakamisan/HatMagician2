...
public class BrandColorPetPurple: BrandColorPet
{
    public override HatMagician2BrandColor Color => HatMagician2BrandColor.Purple;
    ...
    // 如果你挂载了自己的自定义脚本，使用这个
    public override string? CustomVisualPath => "brand_color_purple.tscn".ScenePath();
