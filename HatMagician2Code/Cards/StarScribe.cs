...
public class StarScribe() : HatMagician2Card(2, CardType.Attack, CardRarity.Rare, TargetType.AnyEnemy), IHatMagician2AbstractModel
{
    ...
    [
        ...
        new CustomCalculatedDamageVar("StarScribe", ValueProp.Move).WithMultiplier((card, _) => ((StarScribe)card).GetAccDamage())
    ];
    ...
    private int GetAccDamage()
    {
        return this._accDamage;
    }
