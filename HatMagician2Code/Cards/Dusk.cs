...
public class Dusk() : HatMagician2Card(1, CardType.Power, CardRarity.Uncommon, TargetType.Self)
{
    ...
    {
        await this.CommonApplySelfPower<DuskPower>(choiceContext, play, this.DynamicHat2Var.IntValue);
