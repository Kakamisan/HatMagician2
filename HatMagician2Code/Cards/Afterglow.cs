...
public class Afterglow() : HatMagician2Card(2, CardType.Attack, CardRarity.Uncommon, TargetType.AnyEnemy)
{
    ...
    protected override IEnumerable<IHoverTip> Hat2ExtraHoverTips => [HoverTipFactory.FromPower<AfterglowPower>()];
    protected override IEnumerable<DynamicVar> Hat2ExtraCanonicalVars => [new DamageVar(20, ValueProp.Move), new Hat2Var(2)];
